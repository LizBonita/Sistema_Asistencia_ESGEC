...
<head>
    ...
    <title>Agregar Maestro - Sistema de Asistencia</title>
...
<div class="top-header">
    <div class="top-header-inner">
        <div class="header-title">
            ...
            <div><h1>Agregar Maestro</h1><p>Asigna un usuario existente como maestro</p></div>
        </div>
...
<div class="page-wrapper">
    <div class="form-card">
        <div class="form-card-head">
            ...
            <div><h2>Nuevo Maestro</h2><p>Selecciona el usuario y el tipo de contrato</p></div>
        </div>
        <div class="form-body">
            <form action="../controllers/CrearMaestroController.php" method="POST">
                <div class="form-group">
                    <label><i class="fas fa-user"></i> Usuario Asociado</label>
                    <select name="usuario_id" id="usuario_id" class="form-control" required>
                        <option value="">Seleccionar usuario...</option>
                        <?php while ($row = $stmt_usuarios->fetch(PDO::FETCH_ASSOC)): ?>
                            <option value="<?php echo $row['id']; ?>">
                                <?php echo htmlspecialchars($row['nombre_completo']); ?> (<?php echo htmlspecialchars($row['usuario']); ?>) — <?php echo htmlspecialchars($row['rol_nombre']); ?>
                            </option>
                        <?php endwhile; ?>
                    </select>
                </div>
                ...
                <div class="form-actions">
                    <button type="submit" class="btn-submit"><i class="fas fa-plus-circle"></i> Agregar Maestro</button>
