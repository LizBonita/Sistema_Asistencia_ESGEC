...
$maestro_model = new Maestro($db);

$stmt = $maestro_model->read();
$maestros = $stmt->fetchAll(PDO::FETCH_ASSOC);
$num = count($maestros);

// Obtener lista de usuarios disponibles
$stmt_usuarios = $maestro_model->getUsuariosDisponiblesParaMaestro();
$usuariosDisponibles = $stmt_usuarios->fetchAll(PDO::FETCH_ASSOC);

$totalTiempoCompleto = 0;
$totalPorHoras = 0;

foreach ($maestros as $maestro) {
    $tipoContrato = mb_strtolower(trim((string)($maestro['tipo_contrato'] ?? '')), 'UTF-8');
    if ($tipoContrato === 'tiempo_completo') {
        $totalTiempoCompleto++;
    } elseif ($tipoContrato === 'por_horas') {
        $totalPorHoras++;
    }
}
...
function tipoContratoBonito(string $tipo): string
{
    $tipo = trim(mb_strtolower($tipo, 'UTF-8'));

    return match ($tipo) {
        'tiempo_completo' => 'Tiempo completo',
        'por_horas' => 'Por horas',
        default => $tipo !== '' ? ucwords(str_replace('_', ' ', $tipo)) : 'Sin definir',
    };
}
...
<head>
    ...
    <title>Gestionar Maestros - Sistema de Asistencia Escolar</title>
...
<body>
            ...
            <div class="main-card">
                <div class="main-card-head">
                    <div class="main-card-title">
                        ...
                        <p>Administra los registros del personal docente manteniendo exactamente la misma funcionalidad, ahora con el mismo estilo visual del panel.</p>
                    </div>
                ...
                <div class="summary-grid">
                    <div class="summary-item">
                        <div class="summary-info">
                            <small>Maestros registrados</small>
                    ...
                    <div class="summary-item">
                        <div class="summary-info">
                            ...
                            <strong><?php echo (int)$totalTiempoCompleto; ?></strong>
                        </div>
                        <div class="summary-icon">
                    ...
                    <div class="summary-item">
                        <div class="summary-info">
                            ...
                            <strong><?php echo (int)$totalPorHoras; ?></strong>
                        </div>
                        <div class="summary-icon">
                ...
                <?php if ($num > 0): ?>
                    <div class="tools-row">
                        <div class="search-box">
                            ...
                            <input type="text" id="searchMaestros" placeholder="Buscar por nombre, contrato o fecha...">
                        </div>
                    </div>
                            ...
                            <table id="maestrosTable">
                                ...
                                <tbody>
                                    <?php foreach ($maestros as $row): ?>
                                        <?php
                                            $id = (int)($row['id'] ?? 0);
                                            $nombreCompleto = (string)($row['nombre_completo_usuario'] ?? '');
                                            $tipoContratoRaw = (string)($row['tipo_contrato'] ?? '');
                                            $tipoContrato = tipoContratoBonito($tipoContratoRaw);
                                            $fechaRegistro = (string)($row['fecha_registro'] ?? '');

                                            $tipoClass = 'contract-default';
                                            $tipoLower = mb_strtolower(trim($tipoContratoRaw), 'UTF-8');

                                            if ($tipoLower === 'tiempo_completo') {
                                                $tipoClass = 'contract-completo';
                                            } elseif ($tipoLower === 'por_horas') {
                                                $tipoClass = 'contract-horas';
                                            }

                                            $busqueda = mb_strtolower($nombreCompleto . ' ' . $tipoContrato . ' ' . $fechaRegistro, 'UTF-8');
                                        ?>
                                            ...
                                            <td>
                                                <div class="table-user-cell">
                                                    ...
                                                    <div class="table-user-data">
                                                        ...
                                                        <span>Docente registrado en el sistema</span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <span class="contract-badge <?php echo $tipoClass; ?>">
                                                    <i class="fa-solid fa-id-badge"></i>
                                                    <?php echo htmlspecialchars($tipoContrato, ENT_QUOTES, 'UTF-8'); ?>
                                                </span>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="actions-cell">
                                                    ...
                                                    <a
                                                        ...
                                                        href="../controllers/EliminarMaestroController.php?id=<?php echo $id; ?>"
                                                        onclick="return confirm('¿Estás seguro de eliminar al maestro <?php echo addslashes(htmlspecialchars($nombreCompleto, ENT_QUOTES, 'UTF-8')); ?>?');"
                                                    >
                    ...
                    <div class="mobile-cards" id="mobileCards">
                        <?php foreach ($maestros as $row): ?>
                            <?php
                                ...
                                $busqueda = mb_strtolower($nombreCompleto . ' ' . $tipoContrato . ' ' . $fechaRegistro, 'UTF-8');
                            ?>
                            <article class="mobile-maestro-card" data-search="<?php echo htmlspecialchars($busqueda, ENT_QUOTES, 'UTF-8'); ?>">
                                <div class="mobile-maestro-top">
                                    <div class="table-user-avatar"><?php echo htmlspecialchars(obtenerIniciales($nombreCompleto), ENT_QUOTES, 'UTF-8'); ?></div>
                                    <div class="table-user-data">
                                        <strong><?php echo htmlspecialchars($nombreCompleto, ENT_QUOTES, 'UTF-8'); ?></strong>
                                ...
                                <div class="mobile-maestro-content">
                ...
                <?php else: ?>
                    <div class="empty-state">
                        ...
                        <p>Aún no hay registros disponibles. Puedes comenzar agregando el primer maestro.</p>
    ...
    <!-- MODAL -->
    <div id="createMaestroModal" class="modal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="modal-description">
                    Completa el formulario para registrar un nuevo maestro sin alterar la lógica existente del sistema.
                </p>

                <form id="createMaestroForm" method="POST" action="../controllers/CrearMaestroController.php">
                    <div class="form-grid">
                                        ...
                                        <option value="<?php echo (int)$usuario['id']; ?>">
                                            <?php
                                                echo htmlspecialchars(
                                                    $usuario['nombre_completo'] . ' (' . $usuario['usuario'] . ') - ' . $usuario['rol_nombre'],
                                                    ENT_QUOTES,
                                                    'UTF-8'
                                                );
                                            ?>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const desktopRows = Array.from(document.querySelectorAll('#maestrosTable tbody tr'));
            const mobileCards = Array.from(document.querySelectorAll('#mobileCards .mobile-maestro-card'));

            const modal = document.getElementById('createMaestroModal');
            const openModalBtn = document.getElementById('openModal');
            const openModalEmpty = document.getElementById('openModalEmpty');
            const closeModalBtn = document.getElementById('closeModalBtn');
            const cancelModalBtn = document.getElementById('cancelModalBtn');
            const form = document.getElementById('createMaestroForm');
            const modalMessage = document.getElementById('modalMessage');
            const submitBtn = document.getElementById('submitBtn');

            // MODO NOCHE
            const savedTheme = localStorage.getItem('gestion_maestros_theme');
            if (savedTheme === 'dark') {
            ...
            if (themeToggle) {
                themeToggle.addEventListener('click', function () {
                    ...
                    localStorage.setItem('gestion_maestros_theme', isDark ? 'dark' : 'light');
            ...
            // ENVÍO DEL FORMULARIO USANDO IFRAME OCULTO
            if (form) {
                form.addEventListener('submit', function (e) {
                    ...
                    iframe.name = 'maestro-submit-target-' + Date.now();
                    iframe.style.display = 'none';
                    document.body.appendChild(iframe);

                    form.target = iframe.name;
                    form.action = '../controllers/CrearMaestroController.php';
                    form.method = 'POST';
                    ...
                    function onSuccess() {
                        ...
                        showModalMessage('✅ Maestro creado. Recargando...', 'success');
                    ...
                    function onError() {
                        ...
                        showModalMessage('Ocurrió un problema al registrar el maestro. Verifica la información e inténtalo nuevamente.', 'error');
