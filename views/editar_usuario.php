...
if ($_SESSION['user_rol_nombre'] !== 'Director' && $_SESSION['user_rol_nombre'] !== 'Administrador') { die("Acceso denegado."); }
...
if ($usuario_id) {
    ...
    if (!$usuario->readOne()) { header('Location: gestion_usuarios.php?message=' . urlencode('Usuario no encontrado.')); exit(); }
} else { header('Location: gestion_usuarios.php'); exit(); }
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <style>
        ...
        *{margin:0;padding:0;box-sizing:border-box}body{font-family:'Roboto',sans-serif;background:radial-gradient(900px 420px at 0% 0%,rgba(39,132,211,.12),transparent 55%),radial-gradient(900px 420px at 100% 0%,rgba(34,197,94,.10),transparent 55%),var(--bg);color:var(--text);min-height:100vh}a{text-decoration:none;color:inherit}button,input,select{font-family:inherit}
        ...
        .form-hint{display:flex;align-items:center;gap:8px;padding:12px 16px;border-radius:12px;background:rgba(245,158,11,.08);border:1px solid rgba(245,158,11,.15);color:#92400e;font-size:.88rem;font-weight:600;margin-bottom:20px}body.dark-mode .form-hint{background:rgba(245,158,11,.06);color:#fbbf24}
...
<div class="top-header">
    <div class="top-header-inner">
        <div class="header-title">
            ...
            <div><h1>Editar Usuario</h1><p>Modifica la información de <?php echo htmlspecialchars($usuario->nombre_completo); ?></p></div>
        </div>
        <div class="header-actions">
            <a href="gestion_usuarios.php" class="header-btn"><i class="fas fa-arrow-left"></i> Volver</a>
...
<div class="page-wrapper">
    <div class="form-card">
        <div class="form-card-head">
            ...
            <div><h2><?php echo htmlspecialchars($usuario->nombre_completo); ?></h2><p>Actualiza nombre, usuario y rol</p></div>
        </div>
        <div class="form-body">
            <form action="../controllers/ActualizarUsuarioController.php" method="POST">
                ...
                <div class="form-hint">
                    ...
                    La contraseña no se modifica desde esta vista por seguridad.
                </div>

                <div class="form-group">
                    <label><i class="fas fa-shield-halved"></i> Rol</label>
                ...
                <div class="form-actions">
                    ...
                    <a href="gestion_usuarios.php" class="btn-cancel"><i class="fas fa-times"></i> Cancelar</a>
                </div>
            </form>
        </div>
    </div>
