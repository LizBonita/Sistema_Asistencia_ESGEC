...
if ($materia_id) {
    ...
    if (!$materia->readOne()) { header('Location: gestion_materias.php?message=' . urlencode('Materia no encontrada.')); exit(); }
} else { header('Location: gestion_materias.php'); exit(); }
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>Editar Materia - Sistema de Asistencia</title>
...
<div class="top-header">
    <div class="top-header-inner">
        <div class="header-title">
            ...
            <div><h1>Editar Materia</h1><p>Modifica el nombre de la materia</p></div>
        </div>
        <div class="header-actions">
            <a href="gestion_materias.php" class="header-btn"><i class="fas fa-arrow-left"></i> Volver</a>
...
<div class="page-wrapper">
    <div class="form-card">
        <div class="form-card-head">
            ...
            <div><h2><?php echo htmlspecialchars($materia->nombre_materia); ?></h2><p>Actualiza el nombre de esta materia</p></div>
        </div>
        <div class="form-body">
            <form action="../controllers/ActualizarMateriaController.php" method="POST">
                ...
                <div class="form-group">
                    <label><i class="fas fa-book-open"></i> Nombre de la Materia</label>
                    <input type="text" name="nombre_materia" id="nombre_materia" class="form-control" value="<?php echo htmlspecialchars($materia->nombre_materia); ?>" required>
                </div>
                <div class="form-actions">
                    <button type="submit" class="btn-submit"><i class="fas fa-save"></i> Guardar Cambios</button>
                    <a href="gestion_materias.php" class="btn-cancel"><i class="fas fa-times"></i> Cancelar</a>
                </div>
            </form>
        </div>
    </div>
