...
$stmt = $grupo_model->readOrdered($order);
...
<head>
    ...
    <title>Gestionar Grupos - Sistema de Asistencia Escolar</title>
...
<body>
            ...
            <div class="main-card">
                    ...
                    <div class="tools-row">
                        ...
                        <div class="tools-right">
                            <div class="search-box">
                                ...
                                <input type="text" id="searchGrupos" placeholder="Buscar por ID o nombre...">
                            </div>
                        </div>
                    </div>
                                            ...
                                            <td>
                                                <div class="table-item-cell">
                                                    ...
                                                    <div class="table-item-data">
                                                        ...
                                                        <span>Grupo registrado en el sistema</span>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="actions-cell">
                                                    ...
                                                    <a
                                                        ...
                                                        href="eliminar_grupo.php?id=<?php echo $id; ?>"
                                                        onclick="return confirm('¿Estás seguro de eliminar el grupo <?php echo addslashes(htmlspecialchars($nombre, ENT_QUOTES, 'UTF-8')); ?>?');"
                                                    >
                    ...
                    <div class="mobile-cards" id="mobileCards">
                        <?php foreach ($grupos as $row): ?>
                            <?php
                                ...
                                $busqueda = mb_strtolower($id . ' ' . $nombre, 'UTF-8');
                            ?>
                            <article class="mobile-grupo-card" data-search="<?php echo htmlspecialchars($busqueda, ENT_QUOTES, 'UTF-8'); ?>">
                                <div class="mobile-grupo-top">
                                    <div class="table-item-avatar"><?php echo htmlspecialchars(obtenerIniciales($nombre), ENT_QUOTES, 'UTF-8'); ?></div>
                                    <div class="table-item-data">
                                        <strong><?php echo htmlspecialchars($nombre, ENT_QUOTES, 'UTF-8'); ?></strong>
                                ...
                                <div class="mobile-grupo-content">
                ...
                <?php else: ?>
                    <div class="empty-state">
                        ...
                        <p>Aún no hay registros disponibles. Puedes comenzar agregando el primer grupo.</p>
    ...
    <div id="createGrupoModal" class="modal">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p class="modal-description">
                    Completa el formulario para registrar un nuevo grupo manteniendo el mismo comportamiento del archivo original.
                </p>

                <form id="createGrupoForm" method="POST" action="../controllers/CrearGrupoController.php">
                    <div class="form-grid">
                        <div class="form-group">
                            <label for="nombre">Nombre del grupo</label>
                            <div class="input-wrap">
                                <i class="fa-solid fa-users"></i>
                                <input type="text" name="nombre" id="nombre" required placeholder="Ej. 1°A">
                            </div>
                        </div>
                    </div>
    ...
    <div id="editGrupoModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h3><i class="fa-solid fa-pen-to-square"></i> Editar grupo</h3>
                <button type="button" class="modal-close" id="closeEditModalBtn"><i class="fa-solid fa-xmark"></i></button>
            </div>
            <div class="modal-body">
                <p class="modal-description">Modifica el nombre del grupo seleccionado.</p>
                <form id="editGrupoForm" method="POST" action="../controllers/ActualizarGrupoController.php">
                    <input type="hidden" name="id" id="edit_grupo_id">
                    <div class="form-grid">
                        <div class="form-group">
                            <label for="edit_nombre">Nombre del grupo</label>
                            <div class="input-wrap">
                                <i class="fa-solid fa-users"></i>
                                <input type="text" name="nombre_grupo" id="edit_nombre" required>
                            </div>
                        </div>
                    </div>
                    <div class="modal-actions">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            const desktopRows = Array.from(document.querySelectorAll('#gruposTable tbody tr'));
            const mobileCards = Array.from(document.querySelectorAll('#mobileCards .mobile-grupo-card'));
            ...
            const form = document.getElementById('createGrupoForm');
            const modalMessage = document.getElementById('modalMessage');
            const submitBtn = document.getElementById('submitBtn');

            // MODO NOCHE
            const savedTheme = localStorage.getItem('gestion_grupos_theme');
            if (savedTheme === 'dark') {
            ...
            if (themeToggle) {
                themeToggle.addEventListener('click', function () {
                    ...
                    localStorage.setItem('gestion_grupos_theme', isDark ? 'dark' : 'light');
            ...
            // ENVÍO DEL FORMULARIO CON IFRAME
            if (form) {
                form.addEventListener('submit', function (e) {
                    ...
                    iframe.name = 'grupo-submit-target-' + Date.now();
                    iframe.style.display = 'none';
                    document.body.appendChild(iframe);

                    form.target = iframe.name;
                    form.action = '../controllers/CrearGrupoController.php';
                    form.method = 'POST';
                    ...
                    function onSuccess() {
                        ...
                        showModalMessage('✅ Grupo creado. Recargando...', 'success');
                    ...
                    function onError() {
                        ...
                        showModalMessage('Ocurrió un problema al registrar el grupo. Verifica la información e inténtalo nuevamente.', 'error');
            ...
            const editForm = document.getElementById('editGrupoForm');
            ...
            if (editForm) {
                editForm.addEventListener('submit', function(e) {
                    ...
                    const iframe = document.createElement('iframe');
                    iframe.name = 'edit-grupo-' + Date.now(); iframe.style.display = 'none';
                    document.body.appendChild(iframe); editForm.target = iframe.name;
                    let handled = false;
                    function onDone() { if (handled) return; handled = true; editModalMessage.textContent = '✅ Grupo actualizado.'; editModalMessage.className = 'modal-message success'; editModalMessage.style.display = 'block'; setTimeout(() => { closeEditModal(); location.reload(); }, 1200); }
