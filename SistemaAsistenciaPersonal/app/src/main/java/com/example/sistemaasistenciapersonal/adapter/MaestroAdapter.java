...
public class MaestroAdapter extends RecyclerView.Adapter<MaestroAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        // Mostrar nombre real del maestro en vez de solo IDs
        ...
        holder.tvContrato.setText(m.tipo_contrato != null ? m.tipo_contrato : "Sin contrato");
        holder.tvFecha.setText("Registro: " + (m.fecha_registro != null ? m.fecha_registro : "—"));
    }
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        TextView tvId, tvUsuarioId, tvContrato, tvFecha;
